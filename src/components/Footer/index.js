...
export class FooterComponent extends Component {
  ...
  state = {
    follow: {
      ...
      gh: 'https://github.com/pinn-project'
    }
  }

  // __RENDER <React.Methods>
  render () {
    const { follow } = this.state // Getters.

    return (
      <footer className="ui--footer">
        <div className="ui--footer-under">
          <div className="ui--footer-copyright">
            <p className="p1">Got't Patiphat, Web Profile;</p>
            <p className="p2">v2.1-beta (Dec, 2020) | power by <code>ReactJS</code> &amp; <code>Google Firebase</code></p>
          </div>

          <div className="ui--footer-follow">
            <a className="btn btn-phism" href={follow.fb} target="_blank" rel="external">
              <svg className="icon bi bi-facebook" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-6.932 0-5.046 7.85-5.322 9h-3.487v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877c.188-2.824-.761-5.016 2.051-5.016z"/>
              </svg>
            </a>

            <a className="btn btn-phism" href={follow.tw} target="_blank" rel="external">
              <svg className="icon bi bi-twitter" viewBox="0 0 490.659 490.659" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M487.84,92.931c-3.262-3.567-8.514-4.494-12.8-2.261c-4.406,2.002-8.964,3.65-13.632,4.928
            ...
            <a className="btn btn-phism" href={follow.gh} target="_blank" rel="external">
              <svg className="icon bi bi-github" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
