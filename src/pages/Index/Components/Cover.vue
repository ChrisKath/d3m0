<template>
  <div class="ui--cover">
    <div class="ui--cover-container">
      <div class="type">fullstack web developer</div>
      
      <div class="name">
        <h3 class="white">Hello, i am</h3>
        <h1 class="color">Got't Patiphat</h1>
      </div>
      ...
      <div class="action">
        <a class="btn btn-primary download" href="http://bit.ly/r3sum3dl" target="_blank">
    ...
    <div class="ui--cover-follow">
      <a class="btn btn-primary" href="https://facebook.com/100007468007588" target="_blank">
      ...
      <a class="btn btn-primary" href="https://twitter.com/pinn_project" target="_blank">
      ...
      <a class="btn btn-primary" href="https://github.com/pinn-project" target="_blank">
